...
class LyBoxGpt extends Component
{
    ...
    public function getHistory($num)
    {
        ...
        if ($this->history) {
            $this->historyItems = HistoryGptItem::where('history_id', $this->history->id)->orderBy('created_at', 'desc')->take(60)->get()->reverse();
        }
...
//$this->file_id
    $sufijo = "siempre responde usando código HTML y las listas en etiquetas <ul>, <ol> e <il> según sea necesario pero no crees las etiquetas <HTML>, <body>, <head> ni  <tittle> si puedes utiliza clases boostrap 4 en las propiedades class";
        switch ($prompt) {
            case 1:
