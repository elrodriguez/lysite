<div class="">
    <div class="container page__container">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active"><a
                    href="{{ route('homepage_instructors') }}">{{ __('labels.Instructors') }}</a></li>
    ...
    <div class="container page__container">
        <div class="col-lg-12 p-0 mx-auto">
            <div class="card card-body mb-32pt">
                <div class="row">
                    <div class="col-lg-4">
                        <h4 class="card-title">Ingresar Nuevo Instructor</h4>
                    ...
                    <div class="col-lg-8 d-flex align-items-center">
                        ...
                        <div class="flex">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="name_instructor">{{ __('labels.Instructor name') }} *</label>
                                <input wire:model.defer="name_instructor" type="text" class="form-control" id="name_instructor"
                                    placeholder="{{ __('labels.Instructor name') }}">
                            ...
                            <div>
                                <div class="form-group" id="image_path">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        @error('image_path')
                                            <span class="error">Es obligatorio subir una imagen</span>
                                        @enderror
                                        @if ($image_path)
                                        ...
                                        @else
                                            <img class="img-fluid rounded float-right"
                                                alt="{{ __('labels.Preferably enter an image or photo with square format') }}"
                                                style="max-height: 340px; min-height: 200px; width: auto;"
    ...
    <script>
        window.addEventListener('aca-instructor-create', event => {
            cuteAlert({
                type: "success",
