                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 d-flex align-items-center">
                        ...
                        <div class="flex">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="thesis_title">{{ __('labels.Thesis Title') }} *</label>
                                <input wire:model.defer="thesis_title" type="text" class="form-control" id="thesis_title"
                                    placeholder="{{ __('labels.Thesis Title') }}">
                                @error('thesis_title')
                                    <span class="invalid-feedback-2">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label class="form-label" for="university">{{ __('labels.University') }} *</label>
                            ...
                            <div class="form-group">
                                ...
                                name="month" id="month"
                                type="select" class="form-control" id="month">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <textarea wire:model="details" class="form-control" id="details"
                                        rows="10" cols="80" placeholder="{{ __('labels.Write each detail separated by a comma, for example: detail 1, here detail 2, detail 3') }}"></textarea>
                                    @error('details') <span class="invalid-feedback-2">{{ $message }}</span> @enderror
                                </div>
                                @error('year')
                                    <span class="invalid-feedback-2">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                <div class="form-group" id="image_path">
                                    ...
                                    <input type="file" wire:model="image_path" wire:loading.attr="disabled" class="form-control" id="image_path"
                                    ...
                                    @if ($image_path)
                                        ...
                                        style="max-height: 340px; min-height: 200px; width: auto;" src=" {{ $image_path->temporaryUrl() }}">
                                    @endif
                                </div>
                            </div>
