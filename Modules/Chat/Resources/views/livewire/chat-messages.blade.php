<div>
    ...
    <div id="inbox-chat{{ $k }}" class="ui-widget ui-chatbox" outline="0"
        ...
        <div class="card card-bordered" id="bg-chat{{ $k }}">
            <div class="card-header">
                ...
                <a class="btn btn-xs btn-secondary" wire:click="closeChat('{{ $k }}')" href="javascript:void(0);"
                    data-abc="true">Cerrar <i class="fa fa-times"></i></a>
            </div>
    ...
    <div class="publisher bt-1 border-light">
        ...
        <input id="message{{ $k }}" wire:click="focusTextArea('{{ $k }}')"
            onkeyup="textareaWithoutEnter(event.keyCode, this.id,'{{ $k }}');" wire:model.defer="chats.{{ $k }}.message"
            class="publisher-input" type="text" placeholder="Escribe algo...">
        <a class="publisher-btn text-info" data-abc="true"
        onclick="send_w_click('{{ $k }}')"><i class="fa fa-paper-plane"></i></a>
    </div>
