<div class="">
    <div class="container page__container">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('setting_parameters') }}">Parametros</a></li>
                    ...
                    <div class="col-lg-8 d-flex align-items-center">
                        <form wire:submit.prevent="save" class="flex">
                            <div class="form-group">
                                <label class="form-label" for="name">Codigo Unico *</label>
                                <input wire:model="unique_code" type="text" class="form-control" id="unique_code">
                                @error('unique_code') <span class="invalid-feedback-2">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                @error('valor') <span class="invalid-feedback-2">{{ $message }}</span> @enderror
                            </div>
    ...
    <script>
        window.addEventListener('set-parameter-create', event => {
            cuteAlert({
                type: "success",
