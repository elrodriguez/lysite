<div>
    <div wire:ignore.self class="modal fade" id="modalPartEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check">
                                <input wire:model="state" class="form-check-input" type="checkbox" name="exampleRadios" id="exampleRadios3">
    ...
    <script defer>
        window.addEventListener('open-modal-parts-edit', event => {
            $('#modalPartEditLabel').html(event.detail.title);
            $('#modalPartEdit').modal('show');
        });
