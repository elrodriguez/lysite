    ...
    public function getArticles(Request $request)
    {
        ...
        if (strlen($consulta) > 6) {
            ...
            if ($p_allowed > $p_used) {
                ...
                $consulta = "recomiendame una lista de 5 articulos relacionados a mi tesis: {" . $consulta . "} y luego presenta la lista en idioma Español y luego presenta la misma lista traducida al ingles y luego al portuges. además usa etiquetas html para mostrar las listas";
