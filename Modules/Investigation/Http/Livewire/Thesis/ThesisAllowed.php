...
class ThesisAllowed extends Component
{
    ...
    {
        return view('investigation::livewire.thesis.thesis-allowed', ['people' => $this->getPeople()]);
    }
    ...
    public function changeAllowedThesis($id, $valor){ //id = person_id, valor = allowed
        $person = Person::where('id', $id)->first()->paginate(10);
