    ...
    <div class="container page__container">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a
                    href="{{ route('academic_students') }}">{{ __('academic::labels.students') }}</a></li>
                                ...
                                <div class="col-lg-12">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                                ...
                                                @foreach ($student_courses as $key => $student_course)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button
                                                                onclick="deletes({{ $key }},{{ $student_course['id'] }})"
                                                        ...
                                                        <td>
                                                            <input type="date" name="registered_until"
                                                                id="registered_until"
                                                                onchange="uploadDates({{ $key }}, this.value)"
                                                                value="{{ $student_course['registered_until'] }}">
                                                        </td>
                                                        @if ($student_course['status'] == 1)
                                                            <td class="text-center">
                                                                <span
                                                                    class="badge badge-success">{{ __('labels.Active') }}</span>
                                                            </td>
                                                        @else
                                                            <td class="text-center">
                                                                <span
                                                                    class="badge badge-danger">{{ __('labels.Inactive') }}</span>
                                                            </td>
                                                        @endif
                                                    </tr>
                                                @endforeach
                                            @else
                                                <tr>
                                                    <td class="text-center" colspan="3">No está registrado en
                                                        ningún curso
                                                    </td>
                                                </tr>
                                            @endif
