        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 page-nav" style="padding: 15px 0px 5px 0px;">
                    ...
                    <nav class="nav page-nav__menu" style="padding: 0px 0px 0px 13px;">
                        @foreach ($sections as $key => $section )
                        <a class="nav-link active" style="background: none; font-size: 14px;" href="{{ '#'.$section->id }}">{{ ($key + 1).". ".$section->title }}</a>
                        @endforeach
                    </nav>
                </div>
            </div>
