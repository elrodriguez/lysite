            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-12" wire:ignore>
                            ...
                            <div class="form-group" id="text2">
                                ...
                                <div wire:ignore class="form-group" id="editorForm">
                                    ...
                                    <textarea wire:model="text" name="text" class="form-control" id="editor" rows="10"
                                        cols="80">
                                    </textarea>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <script wire:ignore src="https://cdn.ckeditor.com/ckeditor5/31.1.0/classic/ckeditor.js">
                            </script>
                            @if(count($contents) > 0)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button onclick="deletes({{ $content->id }})" type="button"
                                        class="btn btn-danger btn-sm" title="{{ __('labels.Remove assignment') }}"><i
