                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ route('academic_courses_editar',$course->id) }}" type="button" class="btn btn-info btn-sm"><i class="fa fa-pencil-alt"></i></a>
                                                @endcan
                                                @can('academico_cursos_eliminar')
                                                <button onclick="deletes({{ $course->id }})" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash-alt"></i></button>
                                                @endcan
                                            </div>
                                        </td>
