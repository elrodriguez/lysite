<div class="">
                                                ...
                                                @foreach($instructor_courses as $key => $instructor_course)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button onclick="deletes({{ $key }},{{ $instructor_course['id'] }})" type="button" class="btn btn-danger btn-sm" title="Eliminar"><i class="fa fa-trash-alt"></i></button>
                                                        </td>
    ...
    <script>
        ...
        window.addEventListener('aca-instructor-delete-course', event => {
            cuteAlert({
