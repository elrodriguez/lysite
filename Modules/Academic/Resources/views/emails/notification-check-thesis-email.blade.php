...
<!--  ******************************************* SUBJECT ********************************************************* -->
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <a href="{{ route('investigation_thesis_parts', [$a, $b]) }}"
                                   ...
                                   <!--  ******************************************* Link a Lysite y ver la respuesta ********************************************************* -->
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                    <p> Se revisó: {{ $description_part_thesis }}</p>
                                        </p>
                             ...
                             <!--  ******************************************* Pregunta y Respuesta ********************************************************* -->
                                        <p
                                            ...
                                            {{ $by }}
                                            @if($avatar_url)
                                                <img width="30" height="30" class="rounded-circle" src="{{ $avatar_url }}" alt="" />
                                            @else
                                                <img width="30" height="30" class="rounded-circle" src="{{ ui_avatars_url($by,32,'none') }}" alt="" />
                                            @endif
                                        </p>
                                                    ...
                                                    <p
                                                        ...
                                                        <span class="break-all"
                                                            ...
                                                            href="{{ route('investigation_thesis_parts', [$a, $b]) }}"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">{{ route('investigation_thesis_parts', [$a, $b]) }}</a></span>
                                                    </p>
