...
<!--  ******************************************* SUBJECT ********************************************************* -->
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <a href="{{ route('academic_students_discussion', [$a, $b, $c, $d]) }}"
                                                                                ...
                                                                                {{ __('labels.Go to Lysite') }}</a>
                                   <!--  ******************************************* Link a Lysite y ver la respuesta ********************************************************* -->
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                             ...
                             <!--  ******************************************* Pregunta y Respuesta ********************************************************* -->
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('labels.Answered by').": "}}

                                            {{ $by }}
                                            @if(Auth::user()->avatar)
                                                <img width="30" height="30" class="rounded-circle" src="{{ url('storage/'.Auth::user()->avatar) }}" alt="{{ Auth::user()->name }}" />
                                            @else
                                                <img width="30" height="30" class="rounded-circle" src="{{ ui_avatars_url(Auth::user()->name,32,'none') }}" alt="{{ Auth::user()->name }}" />
                                            @endif
                                        </p>
                           <!--  ******************************************* Nombre de Sujeto que responde ********************************************************* -->
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        Si tienes problemas para ver el correo dale click al siguiente enlace para dirigirte a Lysite y ver tu pregunta en tu Navegador.
                                                        <span class="break-all"
                                                            ...
                                                            href="{{ route('academic_students_discussion', [$a, $b, $c, $d]) }}"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">{{ route('academic_students_discussion', [$a, $b, $c, $d]) }}</a></span>
                                                    </p>
                               <!--  ******************************************* Link para ver respuesta en Lysite ********************************************************* -->
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{ $Year }} Lysite. Todos los derechos reservados.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
