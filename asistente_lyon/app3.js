...
const createRun = async (data) => {
    ...
    const run = await openai.beta.threads.runs.create(data.thread_id, {
        ...
        instructions: "Responde al usuario solo según las instrucciones del asistente, limitate a ayudar y asistir a todo lo relacionado a investiación cientifica, tesis, articulos cientificos y similares; el usuario se llama " + data.user_name,
    });
