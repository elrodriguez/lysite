        ...
        <div class="row">
            ...
            <div class="col-md-4 text-md-right">
                <p class="text-70 brand justify-content-md-end">
                    <img class="brand-icon" src="{{ url('assets/images/logo/black-70@2x.png') }}" width="30" alt="Tutorio"> Tutorio
                </p>
            ...
            <div class="row">
                <div class="col-md-2 col-sm-4 mb-24pt mb-md-0">
                    ...
                    <nav class="nav nav-links nav--flush">
                        <a href="#" class="nav-link mr-8pt"><img src="{{ url('assets/images/icon/footer/facebook-square@2x.png') }}" width="24" height="24" alt="Facebook"></a>
                        <a href="#" class="nav-link mr-8pt"><img src="{{ url('assets/images/icon/footer/twitter-square@2x.png') }}" width="24" height="24" alt="Twitter"></a>
                        <a href="#" class="nav-link mr-8pt"><img src="{{ url('assets/images/icon/footer/vimeo-square@2x.png') }}" width="24" height="24" alt="Vimeo"></a>
                        <a href="#" class="nav-link"><img src="{{ url('assets/images/icon/footer/youtube-square@2x.png') }}" width="24" height="24" alt="YouTube"></a>
                    </nav>
                </div>
