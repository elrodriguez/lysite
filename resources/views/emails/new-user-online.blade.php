...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <!-- Notification 6 -->
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full2"
                        ...
                        <td width="100%" align="center">
                            ...
                            <div class="sortable_inner ui-sortable">
                                ...
                                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center"
                                    class="full2" object="drag-module-small">
                                    <tr>
                                ...
                                <!-- Start Top -->
                                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center"
                                    class="mobile2" bgcolor="#4edeb5"
                                    style="border-top-left-radius: 5px; border-top-right-radius: 5px; background-color: rgb(78, 222, 181);"
                            ...
                            <table width="600" border="0" cellpadding="0" cellspacing="0" align="center"
                                class="full2" object="drag-module-small"
                                style="-webkit-border-bottom-left-radius: 5px; -moz-border-bottom-left-radius: 5px; border-bottom-left-radius: 5px; -webkit-border-bottom-right-radius: 5px; -moz-border-bottom-right-radius: 5px; border-bottom-right-radius: 5px;">
                                <tr>
                                    <td width="600" align="center"
                                        ...
                                        <div class="sortable_inner ui-sortable">
                                            ...
                                            <table width="600" border="0" cellpadding="0" cellspacing="0"
                                                align="center" class="mobile2"
                                                bgcolor="#ffffff"object="drag-module-small"
                                                        ...
                                                        <table width="540" border="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td valign="middle" width="100%"
                                                                    style="text-align: left; font-family: Helvetica, Arial, sans-serif; font-size: 23px; color: rgb(63, 67, 69); line-height: 30px; font-weight: 100;">
                                                                    <!--[if !mso]><!-->
                                                                    <span
                                                                        style="font-family: 'proxima_novathin', Helvetica; font-weight: normal;"><!--<![endif]-->Hola,
                                                                        {{ $data['user_name'] }}
                                                                        <!--[if !mso]><!--></span><!--<![endif]-->
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td valign="middle" width="100%"
                                                                    ...
                                                                    <!--[if !mso]><!--><span
                                                                        ...
                                                                        verifiques tu dirección de correo electrónico
                                                                        ingresando el código que te hemos enviado. Este
                                                                        sencillo paso nos permitirá confirmar que eres
                                                                        tú y asegurarnos de que tu cuenta esté
                            ...
                            <table width="600" border="0" cellpadding="0" cellspacing="0" align="center"
                                class="mobile2" object="drag-module-small">
                                <tr>
                                    <td valign="middle" width="600"
                                        style="text-align: left; font-family: Helvetica, Arial, sans-serif; font-size: 13px; color: rgb(255, 255, 255); line-height: 24px; font-style: italic;">
                                        <!--[if !mso]><!--><span
                                            style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]-->Copyright
                                            {{ env('APP_NAME', 'Laravel') }} {{ date('Y') }},
                                            <!--<![endif]--></span><!--[if !mso]><!-->
                            ...
                            <table width="600" border="0" cellpadding="0" cellspacing="0" align="center"
                                ...
                                <tr>
                                    <td width="600" height="1" style="font-size: 1px; line-height: 1px;">
                                        &nbsp;</td>
                                </tr>
                            </table>
