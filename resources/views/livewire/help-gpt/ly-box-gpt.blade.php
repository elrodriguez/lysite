        ...
        <div class="row justify-content-end">
            ...
            <div class="col-md-6 col-sm-12 d-flex justify-content-center align-items-center">
                <div class="image-der mr-3">
                    <img src="images/ai-blanco.jpg" alt="Card image cap"
                    ...
                    <form class="datos">
                        <div class="mt-2">
                            <select class="form-control" id="exampleFormControlSelect1">
                                <option selected>como investigador</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                                <option>5</option>
                        ...
                        <button type="button" class="btn btn-primary orange-button">Procesar</button>
